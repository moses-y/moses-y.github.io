 ...
 *
 * Usage:
 *   node src/stages/build-symbols.js --budget 20      # repos per run
 *   node src/stages/build-symbols.js --lang python
 *   node src/stages/build-symbols.js --dry-run
 */
const fs = require('fs');
const path = require('path');
const os = require('os');
const { execFileSync } = require('child_process');
const { LANGS, extensionsOf, acceptsLanguage, normalizeImport, ambiguousFor } = require('../lib/lib-languages.js');
const { effectOf } = require('../lib/lib-effects.js');
