 ...
 *
 * Usage:
 *   node src/stages/build-deps.js --budget 120     # repos to fetch this run
 *   node src/stages/build-deps.js --registry 200   # packages to resolve this run
 *   node src/stages/build-deps.js --dry-run
 */
const fs = require('fs');
const path = require('path');
const { mapLimit } = require('../lib/lib-net.js');
const { parseManifest, isParseable } = require('../lib/lib-manifest.js');
