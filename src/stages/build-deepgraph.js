 ...
 *
 * Usage:
 *   node src/stages/build-deepgraph.js --dry-run        # no API calls; show plan + token estimate
 *   node src/stages/build-deepgraph.js --top 30         # originals + top 30 forks by stars
 *   node src/stages/build-deepgraph.js --all            # every repo (heavy)
 *   node src/stages/build-deepgraph.js --only <id>      # a single repo
 */
const fs = require('fs');
