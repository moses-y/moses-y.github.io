 ...
 *
 * Usage:
 *   node src/stages/build-analyze.js --top 30        # originals + top 30 forks by stars
 *   node src/stages/build-analyze.js --all           # every repo
 *   node src/stages/build-analyze.js --only <id>     # one repo
 *   node src/stages/build-analyze.js --force         # rebuild existing
 */
const fs = require('fs');
