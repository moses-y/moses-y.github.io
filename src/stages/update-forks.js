...
const { looksLikeReasoning, isFallbackArticle } = require('../lib/lib-quality.js'), { factsFor } = require('../lib/lib-facts.js'), { detectSubProjects, isCollection } = require('../lib/lib-subprojects.js'), { ARTICLE_VERSION, articleIsCurrent, versionReport } = require('../lib/lib-article-version.js');
...
const { CONFIG, LLM_API_KEY, modelRateLimits, EMBED_MODEL } = require('../lib/lib-config.js');
const { cleanArticle } = require('../lib/lib-text.js');
const { fetchReadme, fetchRepoTree, fetchRepos, fetchRepoDetails,
  generateFallbackSummary } = require('../lib/lib-github.js');
const { mapLimit } = require('../lib/lib-net.js');
const { generateBlogArticle } = require('../lib/lib-article.js');
const { deriveLanguage, domainOf, classifyArtifact, deriveCapabilities, enrichFork } = require('../lib/lib-classify.js');
const { buildKnowledgeGraph, formatKnowledgeGraph } = require('../lib/lib-knowledge-graph.js');
const { buildEmbeddingText, loadEmbeddingsCache, saveEmbeddingsCache, generateEmbeddings,
  cosineSimilarity, computeUmapAndKnn } = require('../lib/lib-embeddings.js');
