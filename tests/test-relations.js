...
const { describe, RECORD } = require('../src/lib/lib-schema.js');
const {
  cluster, communities, stackEdges, packageSets, CLUSTER_AT
} = require('../src/lib/lib-relations.js');
...
/*
 * .claude/skills/query-repo-estate is a consumer that lives outside src/,
