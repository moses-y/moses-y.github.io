 ...
 *   node scripts/measure-runtime-checks.js --sample 24
 *   node scripts/measure-runtime-checks.js --repos a,b,c --verbose
 */
'use strict';
const fs = require('fs');
const hygiene = require('./lib-hygiene.js');
require('./checks-runtime.js');
const { configFiles } = require('./checks-runtime.js');
...
async function main() {
  ...
  for (const name of names) {
    ...
    const chosen = require('./checks-runtime.js').selectPaths(mkCtx());
