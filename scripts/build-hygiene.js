 ...
 *
 * Usage:
 *   node scripts/build-hygiene.js --budget 60
 *   node scripts/build-hygiene.js --only <repo-name>
 *   node scripts/build-hygiene.js --recheck-after 14   # days before a re-audit
 *   node scripts/build-hygiene.js --dry-run
 */
'use strict';
const fs = require('fs');
